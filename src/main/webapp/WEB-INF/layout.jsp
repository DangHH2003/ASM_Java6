			...
			<div class="w-100 d-flex justify-content-between">
				<div>
					<i class="fa fa-envelope mx-2"></i> <a
						...
						href="mailto:info@company.com">danghhpk02275@fpt.edu.vn</a> <i
						class="fa fa-phone mx-2"></i> <a
						class="navbar-sm-brand text-light text-decoration-none"
						href="tel:010-020-0340">0384478403</a>
				</div>
				<div>
			...
			<div
				...
				<div class="flex-fill">
					<ul
						...
						<c:if test="${sessionScope.role == true }">
							<li class="nav-item dropdown"><a
								...
								<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<li><a class="dropdown-item" href="/product">Quản Lý Sản
											Phẩm </a></li>
						...
						<c:if test="${sessionScope.user !=null }">
							<li><a class="nav-link scrollto">Xin chào ${user.fullname}</a></li>
						</c:if>
				...
				<div class="navbar align-self-center d-flex">
					...
					<a class="nav-icon d-none d-lg-inline" href="/cart/index"
						...
						href="/user/login"> <i class="fa fa-fw fa-user text-dark mr-3"></i>
						<span
						class="position-absolute top-0 left-100 translate-middle badge rounded-pill bg-light text-dark"></span>
					</a>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 pt-5">
					<h2 class="h2 text-success border-bottom pb-3 border-light logo">Thông Tin Liên Hệ</h2>
					<ul class="list-unstyled text-light footer-link-list">
						<li><i class="fas fa-map-marker-alt fa-fw"></i> 227 Xô Viết Nghệ Tĩnh</li>
						<li><i class="fa fa-phone fa-fw"></i> <a
							class="text-decoration-none" href="tel:010-020-0340">0384478403</a>
						</li>
						<li><i class="fa fa-envelope fa-fw"></i> <a
							class="text-decoration-none" href="mailto:info@company.com">danghhpk02275@fpt.edu.vn</a>
						</li> 
				...
				<div class="col-md-4 pt-5">
					...
					<ul class="list-unstyled text-light footer-link-list">
						...
						<li><a class="text-decoration-none" href="#">Dây Sạc</a></li>
						<li><a class="text-decoration-none" href="#">Củ Sạc</a></li>
						<li><a class="text-decoration-none" href="#">Sạc Dự Phòng </a></li>
						<li><a class="text-decoration-none" href="#">Ốp Lưng</a></li>
						<li><a class="text-decoration-none" href="#">Tai Nghe </a></li>
						<li><a class="text-decoration-none" href="#">Loa</a></li>
					</ul>
				</div>
