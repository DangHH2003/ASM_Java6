...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	...
	<div class="container-fluid bg-light py-5">
		<div class="col-md-6 m-auto text-center">
			...
			<hr>
			<p>
				CÔNG TY CỔ PHẦN THƯƠNG MẠI VÀ XUẤT NHẬP KHẨU APOLOPH17241 </br> 
				Hotline - Zalo: 0384478403 </br> 
				Showroom 1:  </br>
				Điện thoại: 0384478403 </br>
				Showroom 2:  </br>
				Điện thoại: 0384478403 </br>
				Liên hệ Đối tác & CSKH: 19008198 </br>
				Email: danghhpk02275@fpt.edu.vn</br>
				Website: http://localhost:8080/home </br>
				Người phụ trách: Hoàng Hải Đăng </br>
			</p>
		</div>
	</div>
